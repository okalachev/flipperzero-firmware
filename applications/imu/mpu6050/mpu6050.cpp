...
{
    uint8_t value;
    furi_hal_i2c_trx(&furi_hal_i2c_handle_external, mpuAddress << 1, &reg, 1, &value, 1, 50);
    return value;
    // uint8_t value;
...
void MPU6050::writeRegister8(uint8_t reg, uint8_t value)
{
    ...
    furi_hal_i2c_tx(&furi_hal_i2c_handle_external, mpuAddress << 1, buffer, 2, 50);
...
void MPU6050::writeRegister16(uint8_t reg, int16_t value)
{
    ...
    furi_hal_i2c_tx(&furi_hal_i2c_handle_external, mpuAddress << 1, buffer, 3, 50);
